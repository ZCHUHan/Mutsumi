...
class BatchResponse(BaseModel):
    ...
    output_logprobs: List[List[List[Any]]] = Field(default_factory=list)
    output_top_logprobs: List[List[List[List[Any]]]] = Field(default_factory=list)
...
async def batch_actions(request: BatchRequest):
    ...
    try:
        ...
        for state in states:
            ...
            output_top_logprobs = state.get_meta_info("action").get("output_top_logprobs", [])
            ...
            all_output_logprobs.append(output_logprobs)
            all_output_top_logprobs.append(output_top_logprobs)
        
        return BatchResponse(
            output_ids=all_output_ids,
            actions=all_actions,
            output_logprobs=all_output_logprobs,
            output_top_logprobs=all_output_top_logprobs,
        )
